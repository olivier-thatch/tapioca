...
module ActiveModel
  class << self
    # source://activemodel/8.0.2/lib/active_model/deprecator.rb#4
    def deprecator; end

    # source://activemodel/8.0.2/lib/active_model.rb#76
    def eager_load!; end

    # source://activemodel/8.0.2/lib/active_model/gem_version.rb#5
    def gem_version; end

    # source://activemodel/8.0.2/lib/active_model/version.rb#7
    def version; end
  end
end
